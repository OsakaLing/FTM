...
module parameter
    ...
    double precision, parameter :: omega = 1.6          !加速係数(SOR法)
...
subroutine surface_tension (surface_tension_x,surface_tension_y)
    ...
    ! Do i = 1, nx
    !   do j = 1 , ny
    ! write(100,*)surface_tension_x(i,j),surface_tension_y(i,j)
    ! end do
    ! end do
    ! close(100)
...
subroutine front_advect ( u , v)
    ...
    ! write(100,*)i,uf(i),vf(i),sqrt(uf(i)**2+vf(i)**2)
